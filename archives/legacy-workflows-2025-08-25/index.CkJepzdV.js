...
var require_index_001 = __commonJS({
  "js/index.CkJepzdV.js"(exports) {
    ...
    if (typeof window !== "undefined") {
      window.mobileSafariDebugger = new MobileSafariAuthDebugger();
    }
    ...
    function EnhancedNoPopupProtectedRoute({ children }) {
      ...
      const isMobileSafari = React.useMemo(() => {
        ...
        const result = isMobile && isSafari;
      ...
      const trackStateChange = reactExports.useCallback((phase, data) => {
        ...
        MobileSafariAuthDebugger.trackAuthState(stateEntry.data);
      ...
      reactExports.useEffect(() => {
        const processCallback = () => __async(null, null, function* () {
          ...
          try {
            ...
            const hasCallbackParams = params.has("code") || params.has("state") || params.has("oauth");
            ...
            if (hasCallbackParams) {
              console.log("[OAuthCallback] 🔄 Processing OAuth callback with params");
